...
exports = module.exports = function(app, mongoose) {
  var accountSchema = new mongoose.Schema({
    ...
    imageSetSelectedId: {type:String , default: 'notselected' },
    imageSetPath: {type:String , default: process.env.HOME+'/'+'kdata'+'/' },
    imageSetsPath: {type:String , default: process.env.HOME+'/'+'kdata'+'/' },
    isDefault: {type:Boolean , default: true },
   
    modelImageSetPath: {type:String , default: '/media/ModelImageSets'+'/' },
