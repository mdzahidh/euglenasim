...
exports = module.exports = function(app, mongoose) {
  ...
  require(schemaPath+'/kServerSchema/ImageSet')(app, mongoose);
  require(schemaPath+'/kServerSchema/SetPath')(app, mongoose);
  require(schemaPath+'/kServerSchema/ModelParameters')(app, mongoose);
};
